...
import { MenuIcon } from "@/icons/ico/MenuIcon";
...
export default function StorePage() {
   ...
   return (
      <SafeAreaView edges={["bottom", "top"]} style={{ backgroundColor: appColors.white, flex: 1 }}>
         <ScreenHeader
            headerTitle="Comunity Store"
            leftAction={<Search2 size={28} color={appColors.black} onPress={() => setShowSearchBar(!showSearchBar)} />}
         />
         ...
         <FlatList
            ...
            refreshControl={<RefreshControl refreshing={isFetching} onRefresh={refetch} colors={[appColors.primary]} />}
