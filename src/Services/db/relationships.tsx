...
export const sendFriendRequest = async ({ requester, receiver }: any) => {
...
export const acceptFriendRequest = async ({ id, currentUserId }: any) => {
   const { data } = await supabase
      .from("relationships")
...
export const rejectFriendRequest = async ({ id, currentUserId }: any) => {
   await supabase
      .from("relationships")
...
export const deleteFriendRequest = async ({ id, currentUserId }: any) => {
   await supabase
      .from("relationships")
      .delete()
...
export const getFriends = async ({ currentUserId }: any) => {
