   ...
   return (
      <View className="w-full relative">
         ...
         {showMenu && (
            ...
            <View className="absolute top-10 bg-white elevation-xl rounded-lg shadow-lg w-64">
               <View style={{ borderBottomColor: appColors.bordersLight, borderBottomWidth: 0.5 }} className="p-4">
